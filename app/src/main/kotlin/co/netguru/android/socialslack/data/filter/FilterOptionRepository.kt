...
import co.netguru.android.socialslack.app.UserLocalRepositoryModule
...
@UserScope
class FilterOptionRepository @Inject constructor(@Named(UserLocalRepositoryModule.FILTER_OPTION_SHARED_PREFERENCES_NAME)
