...
@ActivityScope
class FetchPresenter @Inject constructor(private val channelsProvider: ChannelsProvider) : MvpNullObjectBasePresenter<FetchContract.View>(), FetchContract.Presenter {
    ...
    override fun attachView(view: FetchContract.View) {
        ...
        compositeDisposable += channelsProvider.getChannelsList()
                ...
                .flatMapSingle { channelsProvider.countChannelStatistics(it.id, it.name, "user") }
                .toList()
                .subscribeBy(
