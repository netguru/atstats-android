...
class HomeDashboardPresenterTest {
    ...
    companion object {
        ...
        private val USER_PROFILE = UserProfile(EMPTY_STRING,
                ...
                EMPTY_STRING, EMPTY_STRING, EMPTY_STRING,
                EMPTY_STRING, EMPTY_STRING, EMPTY_STRING)
        private val USER = User(EMPTY_STRING, EMPTY_STRING, EMPTY_STRING, EMPTY_STRING, EMPTY_STRING, USER_PROFILE)

        private val DIRECT_CHANNEL_STATISTICS_1 = DirectChannelStatistics(EMPTY_STRING, EMPTY_STRING, 1, 1)
        private val DIRECT_CHANNEL_STATISTICS_2 = DirectChannelStatistics(EMPTY_STRING, EMPTY_STRING, 2, 2)
        private val DIRECT_CHANNEL_STATISTICS_3 = DirectChannelStatistics(EMPTY_STRING, EMPTY_STRING, 3, 3)
